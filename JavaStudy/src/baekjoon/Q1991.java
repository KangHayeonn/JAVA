...
public class Q1991 {
	...
	public static void main(String args[]) throws IOException {
			...
			for(int j=0; j<3; j++) {
				...
				if(str.charAt(0) != '.' ) { // 대문자 알파벳일 때
					if(j==0) {
						...
						n.addLeft(new Tree.Node(str.charAt(0)));
					}
					else {
						n.addRight(new Tree.Node(str.charAt(0)));
					}
		...
		tree.preOrder(new Tree.Node('A'));
		System.out.println();
		tree.inOrder(new Tree.Node('A'));
		System.out.println();
		tree.postOrder(new Tree.Node('A'));
		System.out.println();
	}
}*/
