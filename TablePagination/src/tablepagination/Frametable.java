...
import tablepagination.MainPanel1;
import tablepagination.MainPanel2;
import tablepagination.Frametable;

public class Frametable{
	private JFrame frame;
	private MainPanel1 SubPanel1;
	private MainPanel2 SubPanel2;
	...
	private void Initialize() {
	      frameInit();
	      SubPanel1 = new MainPanel1(frame);
	      SubPanel2 = new MainPanel2(frame);
	}
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
	    	  public void run() {
	              try {
	            	 Frametable window = new Frametable();
